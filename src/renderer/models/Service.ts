...
import { isValidExternalURL } from '@common/helpers/url-helpers';
import UserAgent from './UserAgent';
import { DEFAULT_SERVICE_ORDER, DEFAULT_SERVICE_SETTINGS } from '@common/config';
...
const debug = debugFn('Ferdium:Service');
